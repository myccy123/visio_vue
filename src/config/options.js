...
export default {
    ...
    THEME: [
        ...
        {label: 'infographic', value: 'infographic', backgroundColor: 'transparent'},
        {label: 'purple-passion', value: 'purple-passion', backgroundColor: '#5B5C6E'},
        {label: 'vintage', value: 'vintage', backgroundColor: '#FEF8EF'},
        {label: 'walden', value: 'walden', backgroundColor: 'transparent'},
        {label: 'westeros', value: 'westeros', backgroundColor: 'transparent'},
        {label: 'wonderland', value: 'wonderland', backgroundColor: 'transparent'},
    ],
    FILTER: [
        {label: '=', value: 'eq'},
        {label: '!=', value: 'ne'},
