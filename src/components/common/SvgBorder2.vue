<template>
    <div style="width:100%;height:100%;" ref="svgBorderWrap">
        ...
        >   
            ...
            <g stroke='none' >
                <path ref='svgOutline' :fill='bgColor' :stroke='borderColor' stroke-width='1px' :filter='`url(#${svgKey})`'></path>
                <g>
...
export default {
    ...
    methods:{
        createSvg() {
            ...
            //矩形起始坐标与结束坐标
            let startX = 2,startY = 2,endX = svgWidth-startX,endY = svgHeight-startY,w=endX-startX,h=endY-startY;
            //四个角的倒角
            let corner = 10;
            //边框
