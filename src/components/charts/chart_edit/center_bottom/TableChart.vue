<template>
    <div id="table_box" style="height:100%;overflow:auto">
        <div class="html-chart-down-wrap" v-if="$store.state.tableConfig[0].isDrillDown">
        ...
        <el-table
                ...
                :cell-style="$store.state.tableConfig[0].cellStyle"
                :header-cell-style="$store.state.tableConfig[0].headerStyle"
                :height="tableHeight"
                stripe
    ...
    export default {
        ...
        computed: {
            ...
            tableHeight() {
                ...
                let h = `calc(100% - ${this.$store.state.tableConfig[0].isDrillDown ? 30 : 0}px)`;
                return h
            }
        },
        mounted() {
