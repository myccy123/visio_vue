            ...
            <div class="temp-setting">
                ...
                >
                    ...
                    <el-form-item label="背景色" style="height: 28px">
                        <el-color-picker
                            v-model="templateConfig.backgroundColor"
                            color-format="hex"
                    ...
                    <el-form-item label="宽">
                        <el-input
                            v-model="templateConfig.width"
                            style="width: 80px"
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="高">
                        <el-input
                            v-model="templateConfig.height"
                            style="width: 80px"
                        ></el-input>
                    </el-form-item>
                    <el-form-item>
                ...
                :style="{
                    width:
                        templateConfig.width != ''
                            ? templateConfig.width + 'px'
                            : '',
                    height:
                        templateConfig.height != ''
                            ? templateConfig.height + 'px'
                            : '',
                    paddingRight: templateConfig.width != '' ? '20px' : '',
                }"
            >
                <grid-layout
                    id="draw-win"
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                v-for="(row, i) in item.charts"
                                :style="{
                                    height: 100 / item.charts.length + '%',
                                }"
                                :key="row.id"
                                style="
                                    display: flex;
                            ...
                            >
                                ...
                                >
                                    <div
                                        :mode="item.charts[i].cols[j].mode"
                                        :itemid="idx"
                                        :rowid="i"
                                        :colid="j"
                                        style="
                                    ...
                                    <div v-if="item.showMask" class="arrow-box">
                                        <i
                                            @click="addLeft(item, i, j)"
                                            class="el-icon-arrow-left arrow-btn"
                                        ></i>
                                        <i
                                            @click="addRight(item, i, j)"
                                            class="el-icon-arrow-right arrow-btn"
                                        ></i>
                                        <i
                                            @click="addDown(item, i, j)"
                                            class="el-icon-arrow-down arrow-btn"
                                        ></i>
                                        <i
                                            @click="addUp(item, i, j)"
                                            class="el-icon-arrow-up arrow-btn"
                                        ></i>
                                        <div class="chart-btns">
                                            ...
                                            >
                                                ...
                                                >
                                                    <el-dropdown-item
                                                        command="1"
                                                        >单图模式</el-dropdown-item
                                                    >
                                                    <el-dropdown-item
                                                        command="3"
                                                        >轮播模式</el-dropdown-item
                                                    >
                                                </el-dropdown-menu>
                                            </el-dropdown>
                                            <el-button
                                                @click="delChart(item, i, j)"
                        ...
                        <div class="tool-box">
                            ...
                            <el-tooltip effect="dark" placement="top">
                                ...
                                <i
                                    class="el-icon-location-outline refresh-btn"
                                ></i>
                            </el-tooltip>
                            <el-tooltip
                                effect="dark"
                            ...
                            >
                                <i
                                    class="el-icon-full-screen refresh-btn"
                            ...
                            >
                                <i
                                    class="el-icon-setting refresh-btn"
                                    @click="item.showMask = !item.showMask"
                                ></i>
                            </el-tooltip>
                        ...
                        <SvgBorder
                            v-if="
                                item.svgBorder == 'border1' || !item.svgBorder
                            "
                            ...
                            :svgKey="'svg-filter-' + item.i"
                        ></SvgBorder>
                        <SvgBorder2
                            v-else-if="item.svgBorder == 'border2'"
                            style="position: absolute; z-index: 97"
                            :bgColor="
                                templateConfig.backgroundColor
                                    ? templateConfig.backgroundColor
                ...
                >
                    ...
                    <span slot="footer">
                        <el-button @click="showEditCode = false" size="mini"
                            >取 消</el-button
                        >
                        <el-button
                            @click="confirmHTML"
                ...
                >
                    <el-color-picker
                        v-model="templateConfig.borderColor"
                        color-format="hex"
                        :predefine="predefineColors"
                        size="mini"
                    ></el-color-picker>
                    ...
                    >
                        <div
                            v-for="b in borderOptions"
                            :key="b.value"
                            class="source-icon"
                            @click="confirmBorder(b.value)"
                        >
                            <div
                                v-if="b.value == 'border0'"
                                style="
                                    height: 100%;
                                    width: 100%;
                                    border: 1px dashed #1586ee;
                                    position: absolute;
                                    z-index: 197;
                                "
                            ></div>
                            <SvgBorder
                                v-else-if="
                                    b.value == 'border1' && showEditBorder
                                "
                                style="position: absolute; z-index: 197"
                                bgcolor="transparent"
                                :borderColor="templateConfig.borderColor"
                                :svgKey="'svg-filter-demo-' + b.value"
                            ></SvgBorder>
                            <SvgBorder2
                                v-else-if="
                                    b.value == 'border2' && showEditBorder
                                "
                                style="position: absolute; z-index: 197"
                                bgcolor="transparent"
                                :borderColor="templateConfig.borderColor"
                                :svgKey="'svg-filter-demo2-' + b.value"
                            ></SvgBorder2>
                            <span>{{ b.label }}</span>
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                v-for="(sld, idx) in editingBox.slider"
                                :key="'sld' + idx"
                                class="slider-icon"
                            >
                                id: {{ sld.chartid }}
...
export default {
    ...
    computed: {
        maxRow() {
            if (!this.templateConfig.height) {
                ...
                return (
                    (parseInt(this.templateConfig.height) - this.margin[1]) /
                    (this.rowHeight + this.margin[1])
                );
            }
        },
    },
    ...
    mounted() {
        ...
        if (this.$route.query.id) {
            this.$axios
                .post(this.$api.getTemplate, { id: this.$route.query.id })
                .then((res) => {
                    if (res.data.code === "00") {
                        this.templateId = res.data.data.id;
                        this.layout = res.data.data.layout_info.layout;
                        this.templateConfig =
                            res.data.data.layout_info.templateInfo;
                        this.margin =
                            res.data.data.layout_info.templateInfo.margin;
                        this.cols = res.data.data.layout_info.templateInfo.cols;
                        this.maxId =
                            res.data.data.layout_info.templateInfo.maxId;
                        this.maxChartId =
                            res.data.data.layout_info.templateInfo.maxChartId;
                        this.maxRowId =
                            res.data.data.layout_info.templateInfo.maxRowId;
    ...
    methods: {
                    ...
                    for (let row of item.charts) {
                        for (let col of row.cols) {
                            if (col.mode === "3" && col.slider.length >= 1) {
                                ...
                                col.chartId =
                                    col.slider[col.sliderIndex].chartid;
                                col.chartType =
                                    col.slider[col.sliderIndex].chartType;
                                if (col.chartType == "tableBasic") {
                                    this.renderTable(col);
        ...
        refreshBox(item) {
            this.$nextTick(() => {
                for (let row of item.charts) {
                    for (let col of row.cols) {
                        let ct = echarts.getInstanceByDom(
                            document.getElementById(col.domId)
                        );
        ...
        renderChart(col) {
            ...
            if (col.chartId !== "") {
                this.$axios
                    .post(this.$api.getChart, { id: col.chartId })
                    .then((res) => {
                        if (res.data.code === "00") {
                            let domId = col.domId;

                            this.initMap(
                                res.data.data.formOptions.moreConfig.map
                            ).then(() => {
                                echarts.dispose(dom);
            ...
            html2canvas(document.getElementById("draw-win"), {
                ...
                let data = {
                    ...
                    data: {
                        ...
                        parkId: this.parkId, //浏览器参数，获取园区ID，绑定图表和园区关系
                        templateInfo: {
                            height: _this.templateConfig.height,
                            width: _this.templateConfig.width,
                            backgroundColor:
                                _this.templateConfig.backgroundColor,
        ...
        delSlder(idx) {
            ...
            this.editingBox.chartid = this.editingBox.slider[
                this.editingBox.slider.length - 1
            ];
        ...
        delChart(item, i, j) {
            echarts.dispose(
                document.getElementById(item.charts[i].cols[j].domId)
            );
